...
if __name__ == "__main__":
    ...
    ann_dir = "/raid/Nas-122/项目数据/输电项目/缺陷/标记样本库/训练集/导地线检测xml结果_20260116"
    ann2_dir = "/raid/Nas-122/项目数据/输电项目/缺陷/标记样本库/训练集/Annotations"
    out_dir = "/raid/datasets_defect_model/dx_data/v5.0"

    bujian_class = ['ddx']
    quexian_class = ['ddx_sg','ddx_dg','ddx_ss','ddx_yw','ddx_xs','yjs_sg', 'xjqx', 'fzc_hycp', 'fzc_sh', 'fzc_px','fzc_xs','uxls_sd']
    
    start_multithread(images_dir, image_pkl_path, ann_dir, ann2_dir, out_dir,
                      bujian_class, quexian_class, max_workers=24)